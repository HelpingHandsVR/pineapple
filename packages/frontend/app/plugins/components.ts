...
import GradientCard from '../components/shared/gradient-card/index.vue'
import GraphQLDataTable from '../components/shared/graphql-data-table/index.vue'
import GraphQLSelect from '../components/shared/graphql-select/index.vue'
...
Vue.component('graphql-select', GraphQLSelect)
